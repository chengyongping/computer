...
def getClusterCentures(img_paths, dataset_matrix, num_words):
    ...
    print(centres.shape)
    np.savetxt('D:\\OpenCV-Python-Tutorial-master\\imageRetrieval-master\\1.csv', des_matrix)
    np.savetxt('D:\\OpenCV-Python-Tutorial-master\\imageRetrieval-master\\centres.csv', centres)
...
def retrieval_img(img_path, img_dataset, centures, img_paths):
    ...
    np.savetxt('D:\\OpenCV-Python-Tutorial-master\\imageRetrieval-master\\feature.csv', feature)


# test
# 或者文件中的所有图像
img_paths = get_img_path('E:\\images\\test\\')
num_words = 3  # 聚类中心数
# 得到质心， 和所有样本的sift特征。
